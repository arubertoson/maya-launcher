...
* [UNIX based systems](http://hathaway.cc/post/69201163472/how-to-edit-your-path-environment-variables-on-mac)

Furthermore you can specify your own system variables to create your own environment when launching maya.

**How to add system variables:**

* [Windows](https://www.google.de/search?hl=en&q=how+to+add+system+variables+windows&gws_rd=cr,ssl&ei=qzapVpqiIMucsgGRgoygBA)
* [Unix based systems](http://www.cyberciti.biz/faq/set-environment-variable-linux/)
